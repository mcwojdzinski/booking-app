    ...
    return (
        <div className="grow flex items-center justify-around">
            <div className="w-[400px] -mt-10 ">
                <h1 className="text-4xl text-center font-bold mb-4">Register here</h1>
                <form className="max-w-xl mx-auto  flex flex-col gap-y-3" onSubmit={registerUser}>
                    ...
                    <div className="text-center py-2 text-gray-600">
                        Already a member? <Link to="/login"
                                                className="text-black hover:text-primary transition">Login
                        here</Link>
                    </div>
                </form>
            </div>
